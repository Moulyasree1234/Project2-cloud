...
# Load data
data_path = "/workspaces/Project2-cloud/input/train.csv"  # Update the path to your CSV file
...
product_sentiment.write.csv("/workspaces/Project2-cloud/output/task4/product_sentiments.csv")

# Save evaluation results to a file
with open("/workspaces/Project2-cloud/output/task4/task4_output.txt", "w") as file:
