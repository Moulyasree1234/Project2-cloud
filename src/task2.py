...
# Define file paths
online_retail_data_path = "/workspaces/Project2-cloud/input/Online Retail.csv"

# Define output paths
output_path = "/workspaces/Project2-cloud/output/task2"  # Base path for all output files
