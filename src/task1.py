...
# Define file paths
sales_data_path = "/workspaces/Project2-cloud/input/train.csv"
reviews_data_path = "/workspaces/Project2-cloud/input/Online Retail.csv"

# Define output paths
output_sales_data_path = "output/cleaned_sales_data.csv"
output_reviews_data_path = "output/cleaned_reviews_data.csv"
